...
; Function Attrs: noinline nounwind optnone
define dso_local i32 @func1(i32 %p0) #0 {
entry:
  %p0.addr = alloca i32, align 4
  %var0 = alloca i32, align 4
  %var1 = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone
define dso_local i32 @func2(i32 %p0, i32 %p1) #0 {
entry:
  %p0.addr = alloca i32, align 4
  %p1.addr = alloca i32, align 4
  %var0 = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone
define dso_local i32 @func4(i32 %p0) #0 {
entry:
  %p0.addr = alloca i32, align 4
  %var0 = alloca i32, align 4
  %var1 = alloca i32, align 4
...
entry:
  ...
  %2 = load i32, i32* %var0, align 4
  %call5 = call i32 @func1(i32 %2)
  %3 = load i32, i32* %var0, align 4
  %4 = load i32, i32* %var1, align 4
  %call6 = call i32 @func2(i32 %3, i32 %4)
  %call7 = call i32 @func3()
  %5 = load i32, i32* %var0, align 4
  %call8 = call i32 @func4(i32 %5)
  ret i32 0
}
