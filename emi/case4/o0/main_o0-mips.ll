...
entry:
  ...
  call void @f_printf(i32 signext %3)
...
entry:
  ...
  %3 = load i32, i32* %var1, align 4
  %call5 = call i32 @func1(i32 signext %2, i32 signext %3)
  %4 = load i32, i32* %var0, align 4
  %call6 = call i32 @func2(i32 signext %4)
  %5 = load i32, i32* %var0, align 4
  %call7 = call i32 @func3(i32 signext %5)
  %6 = load i32, i32* %var0, align 4
  %7 = load i32, i32* %var1, align 4
  %8 = load i32, i32* %var2, align 4
  %call8 = call i32 @func4(i32 signext %6, i32 signext %7, i32 signext %8)
  ret i32 0
}
