...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @func0(i32 %p0, i32 %p1) #0 {
entry:
  %p0.addr = alloca i32, align 4
  ...
  store i32 -700, i32* %var5, align 4
  store i32 483, i32* %var6, align 4
  %0 = load i32, i32* %var0, align 4
  ...
  %sub6 = sub nsw i32 %sub5, %4
  %5 = load i32, i32* %var0, align 4
  %add = add nsw i32 %sub6, %5
  %6 = load i32, i32* %p1.addr, align 4
  %sub7 = sub nsw i32 %add, %6
  ...
  store i32 %sub8, i32* %var2, align 4
  ...
  store i32 %add10, i32* %var0, align 4
  ...
  store i32 %sub12, i32* %var2, align 4
  %16 = load i32, i32* %var4, align 4
  %17 = load i32, i32* %var1, align 4
  %sub13 = sub nsw i32 %16, %17
  %18 = load i32, i32* %var3, align 4
  %add14 = add nsw i32 %sub13, %18
  %19 = load i32, i32* %var4, align 4
  %mul15 = mul nsw i32 %add14, %19
  %20 = load i32, i32* %var3, align 4
  %add16 = add nsw i32 %mul15, %20
  store i32 %add16, i32* %var5, align 4
...
entry:
  ...
  store i32 %call4, i32* %var4, align 4
  store i32 -233, i32* %var5, align 4
  store i32 115, i32* %var6, align 4
  ...
  %sub7 = sub nsw i32 %add6, %8
  store i32 %sub7, i32* %var6, align 4
...
entry:
  ...
  %call4 = call i32 @f_rand()
  store i32 %call4, i32* %var4, align 4
  store i32 -619, i32* %var5, align 4
  store i32 108, i32* %var6, align 4
  ...
  %mul7 = mul nsw i32 %add6, %7
  store i32 %mul7, i32* %var6, align 4
  ...
  store i32 %mul10, i32* %var3, align 4
  %15 = load i32, i32* %p0.addr, align 4
  %16 = load i32, i32* %var3, align 4
  %sub11 = sub nsw i32 %15, %16
  %17 = load i32, i32* %var0, align 4
  %mul12 = mul nsw i32 %sub11, %17
  %18 = load i32, i32* %var6, align 4
  %mul13 = mul nsw i32 %mul12, %18
  store i32 %mul13, i32* %p0.addr, align 4
  %19 = load i32, i32* %var6, align 4
  %20 = load i32, i32* %var3, align 4
  %add14 = add nsw i32 %19, %20
  store i32 %add14, i32* %var3, align 4
  %21 = load i32, i32* %var3, align 4
  ret i32 %21
}

; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @func3(i32 %p0) #0 {
entry:
  %p0.addr = alloca i32, align 4
  %var0 = alloca i32, align 4
  %var1 = alloca i32, align 4
  ...
  %call4 = call i32 @f_rand()
  store i32 %call4, i32* %var4, align 4
  store i32 -94, i32* %var5, align 4
  store i32 737, i32* %var6, align 4
  %0 = load i32, i32* %var0, align 4
  %1 = load i32, i32* %var6, align 4
  %mul = mul nsw i32 %0, %1
  %2 = load i32, i32* %var3, align 4
  ...
  store i32 %add6, i32* %var3, align 4
  %9 = load i32, i32* %var3, align 4
  call void @f_printf(i32 %9)
...
entry:
  ...
  %call4 = call i32 @f_rand()
  store i32 %call4, i32* %var4, align 4
  store i32 849, i32* %var5, align 4
  store i32 395, i32* %var6, align 4
  ...
  %9 = load i32, i32* %p2.addr, align 4
  %sub7 = sub nsw i32 %mul, %9
  %10 = load i32, i32* %var2, align 4
  %sub8 = sub nsw i32 %sub7, %10
  %11 = load i32, i32* %var3, align 4
  %add9 = add nsw i32 %sub8, %11
  store i32 %add9, i32* %var4, align 4
  %12 = load i32, i32* %p2.addr, align 4
  %13 = load i32, i32* %var1, align 4
  %sub10 = sub nsw i32 %12, %13
  %14 = load i32, i32* %var5, align 4
  %sub11 = sub nsw i32 %sub10, %14
  store i32 %sub11, i32* %var0, align 4
  %15 = load i32, i32* %var5, align 4
  %16 = load i32, i32* %var1, align 4
  %mul12 = mul nsw i32 %15, %16
  %17 = load i32, i32* %p1.addr, align 4
  %sub13 = sub nsw i32 %mul12, %17
  ...
  %add14 = add nsw i32 %19, %20
  store i32 %add14, i32* %var2, align 4
...
entry:
  ...
  %call4 = call i32 @func0(i32 %0, i32 %1)
  %2 = load i32, i32* %var0, align 4
  %3 = load i32, i32* %var1, align 4
  %call5 = call i32 @func1(i32 %2, i32 %3)
  %4 = load i32, i32* %var0, align 4
  %call6 = call i32 @func2(i32 %4)
  %5 = load i32, i32* %var0, align 4
  %call7 = call i32 @func3(i32 %5)
  %6 = load i32, i32* %var0, align 4
  %7 = load i32, i32* %var1, align 4
  %8 = load i32, i32* %var2, align 4
  %call8 = call i32 @func4(i32 %6, i32 %7, i32 %8)
  ret i32 0
}
