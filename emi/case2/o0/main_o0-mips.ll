...
; Function Attrs: noinline nounwind optnone
define dso_local i32 @func2(i32 signext %p0, i32 signext %p1, i32 signext %p2) #0 {
entry:
  %p0.addr = alloca i32, align 4
  %p1.addr = alloca i32, align 4
  ...
  call void @f_printf(i32 signext %23)
...
entry:
  ...
  %call5 = call i32 @func1(i32 signext %1, i32 signext %2)
  %3 = load i32, i32* %var0, align 4
  %4 = load i32, i32* %var1, align 4
  %5 = load i32, i32* %var2, align 4
  %call6 = call i32 @func2(i32 signext %3, i32 signext %4, i32 signext %5)
  %6 = load i32, i32* %var0, align 4
  %7 = load i32, i32* %var1, align 4
  %call7 = call i32 @func3(i32 signext %6, i32 signext %7)
  %8 = load i32, i32* %var0, align 4
  %9 = load i32, i32* %var1, align 4
  %10 = load i32, i32* %var2, align 4
  %call8 = call i32 @func4(i32 signext %8, i32 signext %9, i32 signext %10)
  ret i32 0
}
