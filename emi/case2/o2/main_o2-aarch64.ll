...
; Function Attrs: noinline nounwind
define dso_local i32 @func2(i32 %p0, i32 %p1, i32 %p2) local_unnamed_addr #2 {
entry:
  %call = tail call i32 @f_scanf_nop()
  ...
  tail call void @f_printf(i32 %sub16)
  %add17 = add nsw i32 %mul8, -969
  tail call void @f_printf(i32 %add17)
  %0 = add i32 %call3, %mul
...
entry:
  ...
  tail call void @f_printf(i32 %mul7)
  %add = sub i32 %p2, %call
...
entry:
  ...
  %call2 = tail call i32 @f_scanf_nop()
  %call3 = tail call i32 @f_rand()
  %call4 = tail call i32 @func0(i32 undef)
  %call5 = tail call i32 @func1(i32 undef, i32 %call1)
  %call6 = tail call i32 @func2(i32 %call, i32 %call1, i32 %call2)
  %call7 = tail call i32 @func3(i32 %call, i32 %call1)
  %call8 = tail call i32 @func4(i32 %call, i32 undef, i32 %call2)
  ret i32 0
}
